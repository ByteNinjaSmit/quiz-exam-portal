      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 animate-fade-in">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h1 className="text-[28px] font-semibold text-gray-800 dark:text-white">Create New Faculty/Admin</h1>
              <p className="text-[16px] text-gray-600 dark:text-gray-300">Add a new faculty or admin member by filling in the details below.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              ...
              <Link to={`/developer/dev/see-all-admins`}>
                <button
...
export default CreateFacultyAdmin;